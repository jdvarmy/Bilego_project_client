...
export default class EventSingleVideo extends React.Component {
  componentDidMount = () => {
  ...
  render() {
    const {title1, title2, sub_title, video, video_image, title_color} = this.props;
        ...
        <rs-module id="rev_slider_13_1" style={{display:'none'}}>
          <rs-slides>
            <rs-slide data-key="rs-45" data-title="Slide" data-anim="ei:d;eo:d;s:800;r:0;t:fade;sl:d;">
              <img src={video_image} data-parallax="8" data-panzoom="d:3000;e:Power4.easeOut;ss:250;se:100;" className="rev-slidebg" data-no-retina alt=""/>
              <rs-bgvideo
